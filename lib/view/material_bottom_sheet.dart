...
class MaterialBottomSheet extends StatefulWidget {
  ...
  const MaterialBottomSheet({super.key, required this.child});
        ...
        children: [
          ...
          AnimatedContainer(
            ...
            margin: hasMaxWidth
                ...
                : null,
            constraints:
                const BoxConstraints(maxWidth: maxWidth, minHeight: 48.0),
            child: GestureDetector(
              onVerticalDragUpdate: (details) {
                if (isAnimating || index == positions.length - 1) return;
                ...
                setState(() {
                  if (isScrollingDown && index > 0) {
                    index--;
                    isAnimating = true;
                  } else if (!isScrollingDown && index < positions.length - 1) {
                    index++;
                    isAnimating = true;
                  }
                });
